...
func mustDefaultRegistry() *Registry {
	registry, err := NewRegistry([]Template{
		{ID: FunctionalCases, Version: "v1", Body: functionalCasesV1, Default: true},
		{ID: OpsCases, Version: "v1", Body: opsCasesV1, Default: true},
		{ID: FailureCases, Version: "v1", Body: failureCasesV1, Default: true},
		{ID: BoundaryCases, Version: "v1", Body: boundaryCasesV1, Default: true},
		{ID: DeepCases, Version: "v1", Body: deepCasesV1, Default: true},
		{ID: DeepRefineCases, Version: "v1", Body: deepRefineCasesV1, Default: true},
	})
	if err != nil {
		panic(err)
	}
